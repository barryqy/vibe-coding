...
def main() -> int:
    ...
    print("first_codex_result=CODEX_HOME=.lab-state/codex/home codex exec --cd \"$PWD\" \"display a small ascii art\"")
    print("first_opencode_result=OPENCODE_CONFIG=.lab-state/opencode-devnet.json opencode run --title vibe-coding-opencode-check --agent plan --model devnet/gpt-4o \"display a small ascii art\"")
