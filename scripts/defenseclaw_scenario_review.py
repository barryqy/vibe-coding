...
def check_code() -> bool:
    ...
    leaky_tictactoe = read_sample("samples/leaky_tictactoe_patch.py")
    ...
    checks = [
        ...
        ("private-key", has(r"BEGIN OPENSSH PRIVATE KEY|sk-[A-Za-z0-9]{20,}", leaky_tictactoe), "secret-material-in-source"),
