...
- `OPENCODE_CONFIG=.lab-state/opencode-devnet.json opencode run --title maze-interactive --agent build --model devnet/gpt-4o "Read the second brain and implement only the OpenCode Next Task."` for the direct Maze unlock prompt
- `AGENTS.md` for shared project guidance
