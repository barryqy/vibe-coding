...
- `OPENCODE_CONFIG=.lab-state/opencode-devnet.json opencode run --title maze-interactive --agent build --model devnet/gpt-4o "Search .second-brain/ for Maze project context. Edit exactly one file: dojo_app/maze_play.py..."` for the scoped Maze play prompt
- `AGENTS.md` for shared project guidance
