...
- `OPENCODE_CONFIG=.lab-state/opencode-devnet.json opencode run --title tictactoe-playable --agent build --model devnet/gpt-4o "Read the second brain for project context. Edit exactly one file: dojo_app/tictactoe_play.py..."` for the scoped tic-tac-toe play prompt
- `AGENTS.md` for shared project guidance
