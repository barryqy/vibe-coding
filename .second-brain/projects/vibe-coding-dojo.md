...
- `dojo_app/maze_play.py` contains the scoped play-loop entrypoint for OpenCode to implement.
...
- When a task asks for playable Maze behavior, implement real movement and redraw behavior in `dojo_app/maze_play.py`; do not edit the stable Maze loader/renderer unless the task explicitly asks for it.
