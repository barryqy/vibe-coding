...
- `samples/skills/` contains clean and intentionally unsafe skills for the DefenseClaw demo.
...
- The DefenseClaw mini-demo passes when skill samples, MCP samples, or admission-gate code changed.
